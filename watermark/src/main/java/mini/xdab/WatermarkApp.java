...
public class WatermarkApp {
    ...
    public void runFromArgs(@NonNull String[] args) {
        parseArgs(args);
    ...
    private void parseArgs(@NonNull String[] args) {
    ...
    private void addArgumentOptions(org.apache.commons.cli.Options options) {
    ...
    private void addQuickTypesOptionGroup(org.apache.commons.cli.Options options) {
    ...
    private void addFlagOptionGroup(org.apache.commons.cli.Options options) {
